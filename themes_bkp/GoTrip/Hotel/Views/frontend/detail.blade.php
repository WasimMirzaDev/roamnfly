...
@section('content')
    <div class="bravo_detail bravo_hotel_detail">
        ...
        <div class="bravo_content">
            ...
            <div class="mt-40">
                @include('Hotel::frontend.layouts.details.map')
            </div>
                ...
                <div class="left">
                    <div class="g-price">
                        ...
                        <div class="price">
                            ...
                            <span class="text-price">{{ $row['pops'][0]['tpc'] ?? 0 }}</span>
                        </div>
                    </div>
    ...
    <script>
        jQuery(function ($) {
            ...
            new BravoMapEngine('map_content', {
                disableScripts: true,
                fitBounds: true,
                center: [{{$row['gl']['lt']}}, {{$row['gl']['ln']}}],
                zoom:{{$row->map_zoom ?? "8"}},
                ready: function (engineMap) {
                    engineMap.addMarker([{{$row['gl']['lt']}}, {{$row['gl']['ln']}}], {
                        icon_options: {
