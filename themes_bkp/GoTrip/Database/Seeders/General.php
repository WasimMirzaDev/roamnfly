...
class General extends  Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    ...
                    'val' => 'Copyright © 2023 by RoamNfly',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>RoamNfly</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
        ...
        DB::table('core_settings')->insert([
            ...
            [
                'name' => "email_header",
                'val' => '<h1 class="site-title" style="text-align: center">RoamNfly</h1>',
                'group' => "general",
            ],
            [
                'name' => "email_footer",
                'val' => '<p class="" style="text-align: center">&copy; 2023 RoamNfly. All rights reserved</p>',
                'group' => "general",
            ],
            [
            ...
            [
                ...
                'val' => '<h1 style="text-align: center">Welcome!</h1>
                    ...
                    <p>Thank you for signing up with RoamNfly! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>RoamNfly</p>',
                'group' => "user",
            ],
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val' => "<p><span style=\"font-size: 14pt;\"><strong>RoamNfly Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>www.gotrip.org</p>",
                'group' => "booking",
            ],
