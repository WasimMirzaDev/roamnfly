        ...
        <div class="row x-gap-20 y-gap-20 pt-20">
            ...
            <div class="col-md-6">
                <div class="form-input ">
                    ...
                    <label class="lh-1 text-16 text-light-1" >{{__("PAN")}} <span class="required">*</span></label>

                </div>
            </div>
            <div class="col-md-6">
                <div class="form-input ">
                    <input type="text"  class="form-control" value="{{$user->passport ?? ''}}" name="passport">
                    <label class="lh-1 text-16 text-light-1" >{{__("Passport")}} <span class="required">*</span></label>
