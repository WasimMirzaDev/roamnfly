...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function __construct(Booking $booking, Enquiry $enquiryClass, protected HotelService $hotelService)
    {
...
//            $booking->sendStatusUpdatedEmails();
    ...
    public function modal(Booking $booking)
    {
        ...
        return view('Booking::frontend.detail.modal', ['booking' => $booking, 'service' => $booking->service ?? $this->hotelService->searchHotelDetail([['id' => $booking->api_id]], true)[0]]);
    }
}
