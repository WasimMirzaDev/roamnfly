<div class="b-panel">
    ...
    <div class="b-table-wrap">
        <div class="b-table b-table-div">
            ...
            <div class="info-phone b-tr">
                <div class="label"><?php echo e(__('PAN')); ?></div>
                <div class="val"><?php echo e($booking->pan); ?></div>
            </div>
            <div class="info-phone b-tr">
                <div class="label"><?php echo e(__('Passport')); ?></div>
                <div class="val"><?php echo e($booking->passport); ?></div>
            </div>
            <div class="info-phone b-tr">
                <div class="label"><?php echo e(__('eD')); ?></div>
                <div class="val"><?php echo e($booking->eD); ?></div>
            </div>
            <div class="info-phone b-tr">
                <div class="label"><?php echo e(__('pid')); ?></div>
                <div class="val"><?php echo e($booking->pid); ?></div>
            </div>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\roamnfly\themes/Base/Booking/Views/emails/parts/panel-customer.blade.php ENDPATH**/ ?>