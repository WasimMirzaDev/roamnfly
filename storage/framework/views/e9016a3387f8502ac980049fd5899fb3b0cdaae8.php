...
min-height: 160px;
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <?php echo $__env->make('Flight::frontend.layouts.return.search.mutli-list-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        window.initialData = {
            ...
            from_where: <?php echo json_encode(Request::query('from_where', []), 512) ?>,
            to_where: <?php echo json_encode(Request::query('to_where', []), 512) ?>,
            flight_seat: []
        };
    
        console.log(window.initialData);
    </script>
    <?php echo $__env->make('Flight::frontend.layouts.return.search.multi-modal-form-book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('Flight::frontend.layouts.return.search.flightFormSelectModalMulti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/GoTrip/Flight/Views/frontend/returnMultiSearch.blade.php ENDPATH**/ ?>