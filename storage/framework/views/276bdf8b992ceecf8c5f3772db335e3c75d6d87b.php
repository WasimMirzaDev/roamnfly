    ...
    <div class="bravo-booking-page padding-content padding-content pt-40 pb-40" >
        <div class="container">
            ...
            <div class="row booking-success-detail">
                ...
                <div class="col-md-4">
                    <?php if($booking->travel_type == 'Round Trip'): ?>
                        <?php echo $__env->make('Flight::frontend/booking/returnDetail',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php elseif($booking->travel_type == 'Multicity'): ?>
                        <?php echo $__env->make('Flight::frontend/booking/multiFlightDetail',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php else: ?>
                        <?php echo $__env->make($service->checkout_booking_detail_file ?? ucwords($booking->object_model).'::frontend/booking/detail',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/GoTrip/Booking/Views/frontend/detail.blade.php ENDPATH**/ ?>