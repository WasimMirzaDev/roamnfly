                                ...
                                <?php if(count($recent_bookings) > 0): ?>
                                    <?php $__currentLoopData = $recent_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(get_bookable_service_by_id($booking->object_model) and $service = ($booking->object_model != 'hotel' && $booking->object_model!='flight') ? $booking->service : $booking->object_model): ?>
                                                    <?php if($service == 'hotel'): ?>
                                                        <a target="_blank" href="<?php echo e(\Modules\Hotel\Services\HotelService::getDetailUrl($booking->api_id)); ?>">
                                                            <?php echo e($booking->title); ?>

                                                        </a>
                                                    <?php elseif($service == 'flight'): ?>
                                                        <a target="_blank" href="<?php echo e(\Modules\Flight\Services\FlightService::getDetailUrl($booking->api_id)); ?>">
                                                            <?php echo e($booking->title); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\modules/Dashboard/Views/index.blade.php ENDPATH**/ ?>