...
<div class="b-panel-title"><?php echo e(__('Flight information')); ?></div>
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        ...
        <?php endif; ?>
        <tr>
            <td class="label"><?php echo e(__('Flight name')); ?></td>
            <td class="val">
                <a href="#"><?php echo clean($booking->title); ?></a>
            </td>
                ...
                <table class="pricing-list" width="100%">
                    <tr>
                        ...
                        <td class="val">
                            ...
                            ?>
                            <strong> <?php echo e(format_money( $price_item)); ?></strong>
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\roamnfly\modules/Flight/Views/emails/new_booking_detail.blade.php ENDPATH**/ ?>