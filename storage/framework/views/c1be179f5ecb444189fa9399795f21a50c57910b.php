            ...
            <div class="review-section">
                <div class="service-info">
                    <div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img src="<?php echo e(asset('uploads/'.$logo)); ?>" class="img-responsive" alt="<?php echo clean($row['sI'][0]['fD']['aI']['name']); ?>">
                            </div>
                            <div class="col-md-6">
                                <h2 class="service-name"><?php echo e($loop->iteration > 1 ? 'Return': 'Depart'); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="mt-2">
                        <h3 class="service-name"><?php echo clean($row['sI'][0]['fD']['aI']['name']); ?></h3>
                    </div>
                    <div class="font-weight-medium  mb-3">
                        <p class="mb-1">
                            <?php echo e(__(':from to :to',['from'=>$row['sI'][0]['da']['name'],'to'=>$row['sI'][0]['aa']['name']])); ?>

                        </p>
                        <?php echo e(__(":duration hrs",['duration'=>(number_format($row['sI'][0]['duration']/60,2))])); ?>
                    ...
                    <div class="flex-self-start justify-content-between">
                        <div class="flex-self-start">
                            ...
                            <div class="text-lh-sm ml-1">
                                <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['dt'])->format('H:i')); ?></h6>
                                <span class="font-size-14 font-weight-normal text-gray-1"><?php echo e($row['sI'][0]['da']['name']); ?></span>
                            </div>
                        </div>
                        <div class="text-center d-none d-md-block d-lg-none">
                            <div class="mb-1">
                                <h6 class="font-size-14 font-weight-bold text-gray-5 mb-0"><?php echo e(__(":duration hrs",['duration'=>(number_format($row['sI'][0]['duration']/60,2))])); ?></h6>
                            </div>
                        </div>
                        <div class="flex-self-start">
                            <div class="mr-2">
                            ...
                            <div class="text-lh-sm ml-1">
                                <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['at'])->format('H:i')); ?></h6>
                                <span class="font-size-14 font-weight-normal text-gray-1"><?php echo e($row['sI'][0]['aa']['name']); ?></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="review-section">
            <ul class="review-list">
                <?php if($booking->start_date): ?>
                    ...
                    <li>
                        <div class="label"><?php echo e(__("Start Duration")); ?></div>
                        <div class="val"><?php echo e(human_time_diff(\Carbon\Carbon::parse($service[0]['sI'][0]['at'])->format('Y-m-d H:i:s'),\Carbon\Carbon::parse($service[0]['sI'][0]['dt'])->format('Y-m-d H:i:s'))); ?></div>
                    </li>
                    <li>
                        <div class="label"><?php echo e(__("Return Date")); ?></div>
                        <div class="val">
                            <?php echo e(display_date($booking->return_start_date)); ?>

                        </div>
                    </li>
                    <li>
                        <div class="label"><?php echo e(__("Return Duration")); ?></div>
                        <div class="val"><?php echo e(human_time_diff(\Carbon\Carbon::parse($service[1]['sI'][0]['at'])->format('Y-m-d H:i:s'),\Carbon\Carbon::parse($service[1]['sI'][0]['dt'])->format('Y-m-d H:i:s'))); ?></div>
                    </li>
                <?php endif; ?>
                <?php
            ...
            <ul class="review-list">
                ...
                <li>
                    <div class="label">
                        ...
                        <?php echo e($index == 0 ? 'Depart' : 'Return'); ?>: <?php echo e(($price)); ?>
...
</div><?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/Base/Flight/Views/frontend/booking/returnDetail.blade.php ENDPATH**/ ?>