...
<div class="d-flex items-center gotrip-header-<?php echo e($headerStyle); ?>">
    <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="text-white <?php if($headerStyle == 'transparent_v3'): ?> d-none xl:d-flex <?php endif; ?> header-logo mr-20" data-x="header-logo" data-x-toggle="is-logo-dark">
...
<?php /**PATH /home/u510181259/domains/techtrack.online/public_html/roamnfly/themes/GoTrip/Layout/parts/header-style/normal.blade.php ENDPATH**/ ?>