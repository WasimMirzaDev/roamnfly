            ...
            <?php if($list_term): ?>
                <?php $__currentLoopData = $list_term; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-xl col-md-4 col-sm-6">
                        ...
                        <a href="<?php echo e(route('event.search',['terms[]' => $term->id])); ?>" class="tourTypeCard -type-1 d-block rounded-4 bg-white border-light rounded-4">
...
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Event/Views/frontend/blocks/term-featured-box/index.blade.php ENDPATH**/ ?>