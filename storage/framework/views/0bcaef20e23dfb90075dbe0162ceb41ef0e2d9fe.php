...
<?php if(!empty($services) and $services->total()): ?>
    <div class="bravo-profile-list-services">
        ...
        <div class="container">
            ...
            <?php else: ?>
                <div class="text-center mt30"><a class="button h-50 px-24 -dark-1 bg-blue-1 text-white d-inline-flex" href="<?php echo e(route('user.profile.services',['id'=>$user->user_name ?? $user->id,'type'=>'event'])); ?>"><?php echo e(__('View all (:total)',['total'=>$services->total()])); ?></a></div>
            <?php endif; ?>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Event/Views/frontend/profile/service.blade.php ENDPATH**/ ?>