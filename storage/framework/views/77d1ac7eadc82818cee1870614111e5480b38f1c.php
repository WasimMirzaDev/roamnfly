                        ...
                        <?php $__currentLoopData = $flight_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-<?php echo e($field['size'] ?? "6"); ?> align-self-center px-10 lg:py-5 lg:px-0">
                                ...
                                <?php switch($field['field']):
                                    ...
                                    <?php case ('from_where'): ?> <?php echo $__env->make('Layout::common.search.fields.airport',['inputName'=>'from_where'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php break; ?>
                                    <?php case ('to_where'): ?> <?php echo $__env->make('Layout::common.search.fields.airport',['inputName'=>'to_where'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php break; ?>
                                    <?php case ('type'): ?> <?php echo $__env->make('Layout::common.search.fields.customAttr',['attr'=>'travel-type','inputName' => 'travel_type'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php break; ?>
                                <?php endswitch; ?>
                            </div>
            ...
            <div class="field-items d-block">
                <?php if(!empty($flight_search_fields)): ?>
                    <div class="row w-100 m-0">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3">
                            <button type="button" class="button -dark-1 py-15 h-20 col-12 rounded-100 bg-blue-1 text-white addCity">
...
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Flight/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>