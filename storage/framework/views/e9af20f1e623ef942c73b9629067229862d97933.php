	...
	<div class="booking-review-content">
		<div class="review-section">
			<div class="service-info">
				<div>
					<h3 class="service-name"><a href="<?php echo e(\Modules\Hotel\Services\HotelService::getDetailUrl($service['id'])); ?>"><?php echo e($service['name']); ?></a></h3>
					<?php if($service['ad']['adr']): ?>
						<p class="address"><i class="fa fa-map-marker"></i>
							<?php echo e($service['ad']['adr']); ?>

						</p>
					<?php endif; ?>
				</div>
				<div>
					<?php if($image_url = $service['img']): ?>
						
							<img src="<?php echo e($service['img'][0]['url']); ?>" class="img-responsive" alt="<?php echo e($service['name']); ?>">
			...
			<ul class="review-list">
				...
				<?php if(!empty($rooms)): ?>
					<?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li class="flex-wrap">
							<div class="label"><?php echo e($room->title); ?> * <?php echo e($room->number); ?></div>
							<div class="val">
				...
				<?php if(!empty($rooms)): ?>
					...
					<?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li class="mb-3 pb-1 border-bottom">
							<h6 class="label text-center font-weight-bold mb-1"><?php echo e($room->title); ?> * <?php echo e($room->number); ?></h6>
							<div>
								<?php if ($__env->exists("Hotel::frontend.booking.detail-room",['room'=>$room,'booking'=>$booking])) echo $__env->make("Hotel::frontend.booking.detail-room",['room'=>$room,'booking'=>$booking], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							</div>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/Base/Hotel/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>