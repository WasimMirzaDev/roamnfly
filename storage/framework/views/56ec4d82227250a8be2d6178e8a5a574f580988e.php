            ...
            <div class="has-skeleton">
                <div class="d-flex items-center h-full">
                    ...
                    <div class="accordion__button">
                            ...
                            <a data-id="<?php echo e($publishedPriceId); ?>" data-index="<?php echo e($index); ?>" href="" onclick="event.preventDefault()" class="button -dark-1 px-30 h-50 bg-blue-1 text-white btn-Select-flight"><?php echo e(__("Select Flight")); ?> <div class="icon-arrow-top-right ml-15"></div></a>
...
<div class="card w-100 shadow-hover-3 mb-4 d-none">
    ...
    <div class="mb-3">
        ...
        <div class="d-flex justify-content-center pl-3 pr-3">
            ...
            <a @click="SelectedPriceID('<?php echo e($publishedPriceId); ?>')" href="" onclick="event.preventDefault()" class="btn btn-primary text-white btn-choose w-100"><?php echo e(__("Select flight")); ?></a>
            
        </div>
    </div>
</div>
<?php /**PATH C:\Users\ADMIN\Documents\projects\roamnfly\themes/GoTrip/Flight/Views/frontend/layouts/return/search/multi-loop-grid.blade.php ENDPATH**/ ?>