                                        ...
                                        <div class="" style="width:72px; color:orange;">
                                            <div class="image-wrapper-go">
                                                <img style="width:52px"
                                                    src="<?php echo e($index == 0 ? asset('/images/hotels.png') : asset('/images/ap.png')); ?>" />
                                            </div>
                                            <button
                                                class="w-100 tabs__button text-15 fw-500 text-dark pb-4 js-tabs-button <?php if($number == 0): ?> is-tab-el-active <?php endif; ?>"
                                                data-tab-target=".-tab-item-<?php echo e($service_type); ?>" style="color: orange;">
                        ...
                        <div class="tabs__content mt-30 md:mt-20 js-tabs-content">
                            <?php if($service_types): ?>
                                ...
                                <?php $__currentLoopData = $service_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div
                                        class="tabs__pane -tab-item-<?php echo e($service_type); ?> <?php if($number == 0): ?> is-tab-el-active <?php endif; ?>">
                                        <?php echo $__env->make(ucfirst($service_type) . '::frontend.layouts.search.form-search',
                                            ['style' => 'normal']
