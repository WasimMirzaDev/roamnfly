                    ...
                    <table class="table table-hover bravo-list-item">
                        ...
                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($service = ($booking->object_model != 'hotel' && $booking->object_model!='flight') ? $booking->service : $booking->object_model): ?>
                                        <?php if($service == 'hotel'): ?>
                                            <a target="_blank" href="<?php echo e(\Modules\Hotel\Services\HotelService::getDetailUrl($row->api_id)); ?>">
                                                <?php echo e($row->title); ?>

                                            </a>
                                        <?php elseif($service == 'flight'): ?>
                                            <a target="_blank" href="<?php echo e(\Modules\Flight\Services\FlightService::getDetailUrl($row->api_id)); ?>">
                                                <?php echo e($row->title); ?>
                                ...
                                <td>
                                    <?php if($service = $row->service ?? $row->object_model): ?>
                                        <div class="dropdown">
                                        ...
                                        <?php echo $__env->make($service->set_paid_modal_file ?? \Modules\Hotel\Services\HotelService::$set_paid_modal_file, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\projects\roamnfly\modules/Report/Views/admin/booking/index.blade.php ENDPATH**/ ?>