<style>
    .custom-header {
        background: linear-gradient(90deg, rgb(255, 73, 89), rgb(255, 104, 74));
    }
</style>
<?php
...
<?php switch($headerStyle):
    case ("transparent_v8"): ?>
        ...
        <?php break; ?>
    <?php default: ?>
        <header data-add-bg="<?php echo e($dataBg); ?>" class="custom-header header <?php echo e($headerClass); ?> js-header bravo_header " data-x="header" data-x-toggle="is-menu-opened">
    ...
    <?php break; ?>
<?php endswitch; ?>
<?php /**PATH /home/u510181259/domains/techtrack.online/public_html/roamnfly/themes/GoTrip/Layout/parts/header.blade.php ENDPATH**/ ?>