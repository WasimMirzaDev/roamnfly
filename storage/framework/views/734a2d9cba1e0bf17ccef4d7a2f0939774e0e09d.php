<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" data-bs-toggle="tab" href="#booking-detail-<?php echo e($booking->id); ?>"><?php echo e(__("Booking Detail")); ?></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#booking-customer-<?php echo e($booking->id); ?>">
    ...
    <?php if(count($booking->passengers)): ?>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#booking-guests-<?php echo e($booking->id); ?>">
...
<div class="tab-content">
    <div id="booking-detail-<?php echo e($booking->id); ?>" class="tab-pane active">
        ...
        <div class="more-booking-review">
            <?php echo $__env->make($service->checkout_booking_detail_file ??  \Modules\Hotel\Services\HotelService::$checkout_booking_detail_file ?? '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Booking/Views/frontend/detail/modal.blade.php ENDPATH**/ ?>