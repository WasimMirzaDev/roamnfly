        ...
        <div class="review-section">
            <div class="service-info">
                <div>
                    ...
                    ?>
                    <img src="<?php echo e(asset('uploads/' . $logo)); ?>" class="img-responsive" alt="<?php echo e(clean($service['sI'][0]['fD']['aI']['name'] ?? '')); ?>">
                </div>
                <div class="mt-2">
                    <h3 class="service-name"><?php echo e(clean($service['sI'][0]['fD']['aI']['name'] ?? '')); ?></h3>
                </div>
                <div class="font-weight-medium mb-3">
                    <p class="mb-1">
                        <?php echo e(__(":from to :to", ['from' => $service['sI'][0]['da']['name'] ?? '', 'to' => $service['sI'][0]['aa']['name'] ?? ''])); ?>

                    </p>
                    <?php echo e(__(":duration hrs", ['duration' => number_format(($service['sI'][0]['duration'] ?? 0) / 60, 2)])); ?>
                ...
                <div class="flex-self-start justify-content-between">
                    <div class="flex-self-start">
                        ...
                        <div class="text-lh-sm ml-1">
                            <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0"><?php echo e(\Carbon\Carbon::parse($service['sI'][0]['dt'] ?? now())->format('H:i')); ?></h6>
                            <span class="font-size-14 font-weight-normal text-gray-1"><?php echo e($service['sI'][0]['da']['name'] ?? ''); ?></span>
                        </div>
                    </div>
                    <div class="text-center d-none d-md-block d-lg-none">
                        <div class="mb-1">
                            <h6 class="font-size-14 font-weight-bold text-gray-5 mb-0"><?php echo e(__(":duration hrs", ['duration' => number_format(($service['sI'][0]['duration'] ?? 0) / 60, 2)])); ?></h6>
                        </div>
                    </div>
                    <div class="flex-self-start">
                        <div class="mr-2">
                        ...
                        <div class="text-lh-sm ml-1">
                            <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0"><?php echo e(\Carbon\Carbon::parse($service['sI'][0]['at'] ?? now())->format('H:i')); ?></h6>
                            <span class="font-size-14 font-weight-normal text-gray-1"><?php echo e($service['sI'][0]['aa']['name'] ?? ''); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <ul class="review-list">
                <?php if($booking->start_date): ?>
                    ...
                    <li>
                        ...
                        <div class="val"><?php echo e(human_time_diff(\Carbon\Carbon::parse($service['sI'][0]['at'] ?? now())->format('Y-m-d H:i:s'), \Carbon\Carbon::parse($service['sI'][0]['dt'] ?? now())->format('Y-m-d H:i:s'))); ?></div>
                    </li>
                <?php endif; ?>
                <?php
                ...
                <?php if(!empty($flight_seat)): ?>
                    <?php $__currentLoopData = $flight_seat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($type['number'])): ?>
                            <li>
                                <div class="label"><?php echo e($type['seat_type'] ?? ''); ?>:</div>
                                <div class="val">
            ...
            <ul class="review-list">
                ...
                <?php if(!empty($flight_seat)): ?>
                    <?php $__currentLoopData = $flight_seat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($type['number'])): ?>
                            <li>
                                <div class="label"><?php echo e($type['seat_type'] ?? ''); ?>: <?php echo e($type['number'] ?? ''); ?> * <?php echo e(format_money($type['price'] ?? 0)); ?></div>
                                <div class="val">
                                    <?php echo e(format_money(($type['price'] ?? 0) * ($type['number'] ?? 0))); ?>
                ...
                <li class="final-total d-block">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="val"><?php echo e(format_money($booking->total ?? 0)); ?></div>
                    </div>
                    <?php if($booking->status != 'draft'): ?>
                        <div class="d-flex justify-content-between">
                            <div class="label"><?php echo e(__("Paid:")); ?></div>
                            <div class="val"><?php echo e(format_money($booking->paid ?? 0)); ?></div>
                        </div>
                        <?php if($booking->paid < $booking->total): ?>
                            <div class="d-flex justify-content-between">
                                <div class="label"><?php echo e(__("Remain:")); ?></div>
                                <div class="val"><?php echo e(format_money(($booking->total ?? 0) - ($booking->paid ?? 0))); ?></div>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </li>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/Base/Flight/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>