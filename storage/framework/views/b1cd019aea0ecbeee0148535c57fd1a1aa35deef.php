                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="fotorama" data-nav="thumbs" data-width="100%" data-auto="false" data-allowfullscreen="true">
                                                    <a v-for="g in room.gallery" :href="g.url"></a>
                                                </div>
                                                <div class="list-attributes">
                                                    <div class="attribute-item">
                                                        <h4 class="title">Room Amenities</h4>
                                                        <ul class="d-flex">
                                                            <li v-for="term in room.terms">
                                                                <i class="input-icon field-icon icofont-check"  data-toggle="tooltip" data-placement="top" :title="term"></i>
                                                                {{ term }}
                                                            </li>
                                                        </ul>
                                                    </div>
                                ...
                                <div class="roomGrid__content">
                                    <div class="room-type-item">
                                            ...
                                            <div class="item col-auto" >
                                                <div class="tooltip -top h-50">
                                                    <div class="tooltip__text">
                                                        ...
                                                        <span v-html="room.ipr"></span>
                                                    </div>
                                                    <div class="tooltip__content"><?php echo e(__('Pan Required')); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="room-attribute mt-10" v-if="room.term_features">
                                            <div class="d-flex items-center" v-for="des in room.desc">
                                                <i class="input-icon field-icon text-20 mr-10 icofont-check"></i>
                                                <div class="text-15">{{ des }}</div>
                                            </div>
                                            <div class="d-flex items-center" v-for="term_child in room.term_features">
                                                <i class="input-icon field-icon text-20 mr-10 icofont-check"></i>
                                                <div class="text-15">{{ term_child }}</div>
                                            </div>
                                        </div>
                                        
                                        <div class="d-flex items-center">
                                            <i class="input-icon field-icon text-20 mr-10 icofont-check"></i>
                                            <div class="text-15">PAN Required : {{ room.ipr }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/GoTrip/Hotel/Views/frontend/layouts/details/hotel-room-list.blade.php ENDPATH**/ ?>