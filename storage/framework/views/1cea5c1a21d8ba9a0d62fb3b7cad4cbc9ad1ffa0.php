        ...
        <div class="text-15 text-light-1 ls-2 lh-16">
            <div class="render">
                <span class="adults">
                    ...
                    <span class="multi <?php if($adults <= 1): ?> d-none <?php endif; ?>" data-html="<?php echo e(__(':count Adults')); ?>"><?php echo e(__(':count Adults', ['count' => $adults])); ?></span>
                </span>
                -
                <span class="children">
                    <span class="one <?php if($children > 1): ?> d-none <?php endif; ?>" data-html="<?php echo e(__(':count Child')); ?>"><?php echo e(__(':count Child', ['count' => $children])); ?></span>
                    <span class="multi <?php if($children <= 1): ?> d-none <?php endif; ?>" data-html="<?php echo e(__(':count Children')); ?>"><?php echo e(__(':count Children', ['count' => $children])); ?></span>
                </span>
            </div>
        </div>
    </div>
                ...
                <div class="col-auto">
                    <div class="d-flex items-center">
                        ...
                        <span class="flex-center size-20 ml-15 mr-15 count-display">
                            <input type="number" name="room" value="<?php echo e($room); ?>" min="1">
                        </span>
            ...
            <div class="row y-gap-10 justify-between items-center">
                ...
                <div class="col-auto">
                    <div class="d-flex items-center">
                        ...
                        <span class="flex-center size-20 ml-15 mr-15 count-display">
                            <input type="number" name="adults" value="<?php echo e($adults); ?>" min="1">
                        </span>
            ...
            <div class="row y-gap-10 justify-between items-center">
                ...
                <div class="col-auto">
                    <div class="d-flex items-center">
                        ...
                        <span class="flex-center size-20 ml-15 mr-15 count-display">
                            <input type="number" name="children" value="<?php echo e($children); ?>" min="0">
                        </span>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/GoTrip/Layout/common/search/fields/guests.blade.php ENDPATH**/ ?>