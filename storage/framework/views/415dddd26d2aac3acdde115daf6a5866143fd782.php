    ...
    <div class="bravo-booking-page padding-content padding-content pt-40 pb-40" >
        <div class="container">
            ...
            <div class="row booking-success-detail">
                ...
                <div class="col-md-4">
                    <?php echo $__env->make($service->checkout_booking_detail_file ?? 'Hotel::frontend/booking/detail',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Booking/Views/frontend/detail.blade.php ENDPATH**/ ?>