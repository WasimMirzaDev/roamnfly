...
<?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="sidebar__item g-filter-item">
            ...
            <div class="sidebar-checkbox ">
                <?php $__currentLoopData = $item->terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row y-gap-10 items-center justify-between <?php if($key > 2 and empty($selected[$item->id])): ?> hide <?php endif; ?>">
                        <div class="col-auto">
                            <label  class="cursor-pointer">
                                <div class="form-checkbox d-flex items-center">
                                    <input <?php if(in_array($term->id,$selected[$item->id] ?? [])): ?> checked <?php endif; ?> type="checkbox" name="attrs[<?php echo e($item->id); ?>][]" value="<?php echo e($term->id); ?>">
                ...
                <?php if(count($item->terms) > 3 and empty($selected[$item->id])): ?>
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/u510181259/domains/techtrack.online/public_html/roamnfly/themes/GoTrip/Layout/global/search/filters/attrs.blade.php ENDPATH**/ ?>