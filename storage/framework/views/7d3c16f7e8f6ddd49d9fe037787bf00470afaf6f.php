<div class="form-checkout" id="form-checkout" >
    ...
    <div class="form-section">
        <div class="row x-gap-20 y-gap-20 pt-20">
            ...
            <div class="col-md-6">
                <div class="form-input ">
                    <input type="text"  class="form-control" value="<?php echo e($user->pan ?? ''); ?>" name="pan">
                    <label class="lh-1 text-16 text-light-1" ><?php echo e(__("PAN")); ?> <span class="required">*</span></label>

                </div>
            </div>
            <div class="col-md-6">
                <div class="form-input ">
                    <input type="text"  class="form-control" value="<?php echo e($user->passport ?? ''); ?>" name="passport">
                    <label class="lh-1 text-16 text-light-1" ><?php echo e(__("Passport")); ?> <span class="required">*</span></label>
...
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>