                ...
                <div class="row y-gap-10 items-center">
                    <div class="col-sm-auto">
                        <div class="has-skeleton">
                            ...
                            ?>
                            <img class="size-40" src="<?php echo e(asset('uploads/'.$logo)); ?>" alt="<?php echo e($row['sI'][0]['fD']['aI']['name']); ?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="row x-gap-20 items-end">
                            <div class="col-auto">
                                <div class="has-skeleton">
                                    <div class="lh-15 fw-500"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['dt'])->format('D M d H:i')); ?></div>
                                    <div class="text-15 lh-15 text-light-1"><?php echo e($row['sI'][0]['da']['name']); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="has-skeleton">
                                    <div class="lh-15 fw-500"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['at'])->format('D M d H:i')); ?></div>
                                    <div class="text-15 lh-15 text-light-1"><?php echo e($row['sI'][0]['aa']['name']); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-auto">
                        <div class="text-15 text-light-1 px-20 md:px-0 has-skeleton"><?php echo e((number_format($row['sI'][0]['duration']/60,2)).'h'); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-auto">
                <div class="has-skeleton">
                    <div class="d-flex items-center h-full">
                        ...
                        <div>
                            ...
                            $publishedPrice     = $publishedPrices[0]['fd']['ADULT']['fC']['TF'] ?? $row['totalPriceList'][0]['fd']['ADULT']['fC']['TF'];
                            $publishedPriceId   = $publishedPrices[0]['id']?? $row['totalPriceList'][0]['id'];
                            ?>
...
<div class="card w-100 shadow-hover-3 mb-4 d-none" >
    <a href="#" class="d-block mb-0 mx-1 mt-1 p-3" tabindex="0">
        <img class="card-img-top" src="" alt="<?php echo e($row['sI'][0]['fD']['aI']['name']); ?>">
    </a>
    <div class="card-body px-3 pt-0 pb-3 my-0 mx-1">
        <div class="row">
            <div class="col-7">
                <a href="#" class="card-title text-dark font-size-17 font-weight-bold" tabindex="0"><?php echo e($row['sI'][0]['da']['name']); ?></a>
            </div>
            <div class="col-5">
            ...
            <div class="px-3">
                <div class="d-flex mx-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="font-size-14 text-gray-1"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['dt'])->format('D M d H:i A')); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-3">
                <div class="d-flex mx-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="font-size-14 text-gray-1"><?php echo e(\Carbon\Carbon::parse($row['sI'][0]['at'])->format('D M d H:i A')); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/u510181259/domains/roamnfly.com/public_html/themes/GoTrip/Flight/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>