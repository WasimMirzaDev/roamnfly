                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <h2 class="text-22 fw-500"><?php echo e(__('Let us know who you are')); ?></h2>
                         <div class="booking-form ">
                             <?php echo $__env->make($checkout_form_file ?? 'Booking::frontend/booking/checkout-form',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="col-xl-5 col-lg-4">
                        <div class="ml-80 lg:ml-40 md:ml-0">
                            <?php echo $__env->make($checkout_booking_detail_file ?? '',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\themes/GoTrip/Booking/Views/frontend/checkout.blade.php ENDPATH**/ ?>