...
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="val">
                <a href="<?php echo e(\Modules\Hotel\Services\HotelService::getDetailUrl($service['id'])); ?>"><?php echo e($service['name']); ?></a>
            </td>
        </tr>
        <tr>
                ...
                <table class="pricing-list" width="100%">
                    ...
                    <?php if(!empty($rooms)): ?>
                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="label"><?php echo e($room->title); ?> * <?php echo e($room->number); ?>
...
<?php /**PATH C:\Users\ADMIN\Documents\projects\RoamnFlyGitHub\roamnfly\modules/Hotel/Views/emails/new_booking_detail.blade.php ENDPATH**/ ?>