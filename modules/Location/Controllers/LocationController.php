...
use Modules\Location\Services\ImportLocationService;

class LocationController extends Controller
{
    public $location;
    public function __construct(Location $location,protected ImportLocationService $importLocationService)
    {
    ...
    public function getLocations(Request $request){
        $locations  =   $this->importLocationService->importLocations();
        dd(true);
    }
}