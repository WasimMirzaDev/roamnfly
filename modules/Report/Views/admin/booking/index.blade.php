                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                <td><input type="checkbox" class="check-item" name="ids[]" value="{{$row->id}}">
                                    #{{$row->id}}</td>
                                <td>
                                    @if($service = ($booking->object_model != 'hotel' && $booking->object_model!='flight') ? $booking->service : $booking->object_model)
                                        @if ($service == 'hotel')
                                            <a target="_blank" href="{{ \Modules\Hotel\Services\HotelService::getDetailUrl($row->api_id) }}">
                                                {{ $row->title }}
                                            </a>
                                        @elseif ($service == 'flight')
                                            <a target="_blank" href="{{ \Modules\Flight\Services\FlightService::getDetailUrl($row->api_id) }}">
                                                {{ $row->title }}
                                            </a>
                                        @else
                                ...
                                <td>
                                    @if($service = $row->service ?? $row->object_model)
                                        <div class="dropdown">
                                        ...
                                        @include ($service->set_paid_modal_file ?? \Modules\Hotel\Services\HotelService::$set_paid_modal_file)
                                    @endif
                                </td>
                            </tr>
                        @endforeach
