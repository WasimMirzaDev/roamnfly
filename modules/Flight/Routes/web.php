...
Route::group(['prefix'=>config('flight.flight_route_prefix')],function(){
    ...
    Route::post('getMultiData/{id}',"FlightController@getMultiData")->name('flight.getMultiData');
    Route::post('/addToCart','FlightController@addToCart');
    Route::post('/MultiaddToCart','FlightController@MultiaddToCart');
