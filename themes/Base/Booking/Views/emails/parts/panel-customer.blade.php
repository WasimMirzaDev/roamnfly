<div class="b-panel">
    ...
    <div class="b-table-wrap">
        <div class="b-table b-table-div">
            ...
            <div class="info-phone b-tr">
                <div class="label">{{__('PAN')}}</div>
                <div class="val">{{$booking->pan}}</div>
            </div>
            <div class="info-phone b-tr">
                <div class="label">{{__('Passport')}}</div>
                <div class="val">{{$booking->passport}}</div>
            </div>
            <div class="info-phone b-tr">
                <div class="label">{{__('eD')}}</div>
                <div class="val">{{$booking->eD}}</div>
            </div>
            <div class="info-phone b-tr">
                <div class="label">{{__('pid')}}</div>
                <div class="val">{{$booking->pid}}</div>
            </div>
