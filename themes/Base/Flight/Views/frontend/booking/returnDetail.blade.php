                    ...
                    <div class="flex-self-start justify-content-between">
                        <div class="flex-self-start">
                            ...
                            <div class="text-lh-sm ml-1">
                                <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0">{{\Carbon\Carbon::parse($row['sI'][0]['dt'])->format('H:i')}}</h6>
                                <span class="font-size-14 font-weight-normal text-gray-1">{{$row['sI'][0]['da']['name']}}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex-self-start">
                            ...
                            <div class="text-lh-sm ml-1">
                                <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0">{{\Carbon\Carbon::parse($row['sI'][0]['at'])->format('H:i')}}</h6>
                                <span class="font-size-14 font-weight-normal text-gray-1">{{$row['sI'][0]['aa']['name']}}</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="review-section">
            <ul class="review-list">
                @if($booking->start_date)
                    ...
                    <li>
                        <div class="label">{{ __("Return Date") }}</div>
                        <div class="val">
                            {{display_date($booking->return_start_date)}}
                        </div>
                    </li>
                    <li>
