        ...
        <div class="bg-white px-30 py-30 rounded-4 last-tab" >
            ...
            <div class="row y-gap-10">
                @foreach($seatType as $type)
                    ...
                    <div class="col-1">
                        <input style="width:auto;" data-name="{{ __($type->name) }}" class="form-check-input countTravellers class" type="radio" name="seat_type[class]" value="{{$type->code}}" id="seatType{{$type->code}}" {{ $seatClass == $type->code ? 'checked' : '' }}>
                    </div>
                    <div class="col-5">
