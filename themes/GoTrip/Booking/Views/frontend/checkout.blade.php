                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-8">
                        @if(!auth()->user())
                            <div class="py-15 px-20 mb-40 md:md-24 rounded-4 text-15 bg-blue-1-05">
                                <a data-bs-toggle="modal" href="#login" class="text-blue-1 fw-500">{{__('Sign in')}}</a> {{__('to book with your saved details or')}}
                        ...
                        <h2 class="text-22 fw-500">{{__('Let us know who you are')}}</h2>
                         <div class="booking-form ">
                             @include ($checkout_form_file ?? 'Booking::frontend/booking/checkout-form',['disable_lazyload'=>1])
                    ...
                    <div class="col-xl-5 col-lg-4">
                        <div class="ml-80 lg:ml-40 md:ml-0">
                            @include ($checkout_booking_detail_file ?? '',['disable_lazyload'=>1])
                        </div>
                    </div>
                </div>
            </div>
