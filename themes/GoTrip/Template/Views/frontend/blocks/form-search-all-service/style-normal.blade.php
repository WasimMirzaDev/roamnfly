                            ...
                            @if($service_types)
                                ...
                                @foreach($service_types as $index => $service_type)
                                    ...
                                    <div class="" style="width:72px; color:orange;">
                                        ...
                                        <button class="w-100 tabs__button text-15 fw-500 text-dark pb-4 js-tabs-button @if($number==0) is-tab-el-active @endif" data-tab-target=".-tab-item-{{$service_type}}" style="color: orange;">
